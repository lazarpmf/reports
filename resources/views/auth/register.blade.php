                    ...
                    <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>Nedozvoljen unos. Ime se već koristi.</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>Nedozvoljen unos. Mejl se već koristi.</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>Lozinka mora sadržati minimum 8 karaktera.</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
